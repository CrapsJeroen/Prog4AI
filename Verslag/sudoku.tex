...
During all of the experiments we used the same computer\footnote{TODO computer specifications}.
...
\cline{2-6}
\multicolumn{1}{c|}{} & \begin{sideways}ECLiPSe labeling\end{sideways} & \begin{sideways}ECLiPSe Input First\end{sideways} & \begin{sideways}ECLiPSe First Fail\end{sideways} & \begin{sideways}ECLiPSe Anti First Fail\end{sideways} & \begin{sideways}CHR\end{sideways}\\ \tabucline[2pt]{-}             
medium			&	&	&	&	&	\\
difficult		&	&	&	&	&	\\
verydifficult	&	&	&	&	&	\\
expert			&	&	&	&	&	\\
