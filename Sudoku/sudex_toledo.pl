...
peter(P) :- P = [
        [3,_,14,_,15,7,4,16,_,_,6,5,_,_,_,_],
        [12,_,_,_,_,_,_,11,_,10,16,13,_,5,_,_],
        [_,_,_,_,6,9,5,_,_,_,_,_,13,12,8,14],
        [7,11,_,4,_,_,_,_,_,_,_,_,_,16,_,_],
        [_,13,1,_,9,12,8,6,_,_,_,_,_,_,_,_],
        [10,_,15,_,_,16,_,13,_,11,_,6,9,_,_,_],
        [_,_,16,_,_,_,_,5,_,1,12,7,10,13,_,_],
        [11,9,12,_,_,_,2,10,_,_,15,_,3,7,_,5],
        [13,3,8,_,4,2,12,7,_,_,9,_,_,_,16,_],
        [_,_,_,_,_,11,_,8,_,16,_,2,_,9,15,_],
        [9,_,11,2,_,_,_,_,_,4,7,10,_,_,3,8],
        [_,_,_,16,_,1,_,9,_,_,_,8,_,4,2,_],
        [_,1,9,14,2,10,11,_,_,_,_,_,8,_,_,16],
        [16,6,10,15,_,8,9,_,_,_,13,12,_,_,_,11],
        [_,12,_,_,5,3,15,4,_,_,_,_,14,_,_,7],
        [_,_,_,_,16,_,_,_,11,15,8,_,_,_,1,4]].
